...
class SecureRepository {
  ...
  static Future<void> secureStore(String key, String value, {String? userId}) async {
  ...
  static Future<void> secureStoreObject(String key, Map<String, dynamic> object, {String? userId}) async {
  ...
  static Future<Map<String, dynamic>?> secureRetrieveObject(String key, {String? userId}) async {
  ...
  static Future<Map<String, dynamic>> _encryptSensitiveFields(Map<String, dynamic> object) async {
  ...
  static Future<Map<String, dynamic>> _decryptSensitiveFields(Map<String, dynamic> object) async {
    final result = Map<String, dynamic>.from(object);
