...
sam deploy --template template-fixed-final.yaml --stack-name agendafacil-dev --capabilities CAPABILITY_IAM --parameter-overrides Environment=dev --no-confirm-changeset
if %ERRORLEVEL% neq 0 (
